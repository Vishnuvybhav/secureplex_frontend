...
export default styled(Select)(({ theme, ownerState }) => {
  ...
  // styles for the select with size="small"
  const smallStyles = () => ({
    fontSize: fontSize.xs,
    padding: `${pxToRem(4)} ${pxToRem(12)}`,
  });

  // styles for the select with size="large"
  const largeStyles = () => ({
    padding: pxToRem(12),
  });

  // styles for the focused state of the select
  ...
  // styles for the select containing an icon
